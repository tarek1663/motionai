...
/** Fond type Bolt (rayons rouges) — réutilisable sur le dashboard */
export function RayBackground({ className }: { className?: string }) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center 800px, rgba(239, 68, 68, 0.75) 0%, rgba(239, 68, 68, 0.32) 14%, rgba(220, 38, 38, 0.16) 18%, rgba(185, 28, 28, 0.08) 22%, rgba(17, 17, 20, 0.2) 25%)",
        }}
      />
      <div
      ...
      >
        ...
        <div
          ...
          style={{ border: "23px solid #f6c4c4", transform: "rotate(180deg)", zIndex: 4 }}
        />
        <div
          className="absolute w-full h-full rounded-full bg-[#0f0f0f] -mt-[8px]"
          style={{ border: "23px solid #f28f8f", transform: "rotate(180deg)", zIndex: 3 }}
        />
        <div
          className="absolute w-full h-full rounded-full bg-[#0f0f0f] -mt-[4px]"
          style={{ border: "23px solid #ef4444", transform: "rotate(180deg)", zIndex: 2 }}
        />
        <div
          className="absolute w-full h-full rounded-full bg-[#0f0f0f]"
          style={{
            border: "20px solid #dc2626",
            boxShadow: "0 -15px 24.8px rgba(220, 38, 38, 0.55)",
            transform: "rotate(180deg)",
            zIndex: 1,
          }}
        />
...
/** Fond plein écran pour le dashboard (noir uni, ne remplace pas le bloc prompt) */
export function BoltDashboardBackground({ className }: { className?: string }) {
  return (
    <div
      className={cn("dash-bolt-background fixed inset-0 z-0 pointer-events-none", className)}
      aria-hidden
    />
  );
}
...
export const Component = BoltStyleChat;
