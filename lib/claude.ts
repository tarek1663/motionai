...
- Types autorisés : singleword, maskreveal, slideword, zoomword, fadeupl, blurin, scalein, slideup, cliptop, staggerwords, fadepure, tracking, rotatein, photoreveal, photocollage, counter, progressbar, multistats, accentword, underline, colorshift, linedraw, shape, expandingshape, wipe, flash, colorfade, splitvertical, zoomtransition, iris, curtain, diagonalwipe, glitchswitch, pixeldissolve, lightsweep, notification, pulsebutton, uiprogress, quote, beforeafter, timeline, socialstats, cinematictitle, checklist, location, productmockup, headline, audioviz
